...
<body class="mx-2 md:mx-1 font-andika">
    <div class='border-b-2 border-cyan-900 z-10 p-4 bg-cyan-700 fixed top-0 right-0 left-0'>
        <button onclick="return setSidebar()" class="absolute left-6 top-6 hidden md:inline">
    ...
    <div id="container" class="mx-auto md:ml-60 mt-[72px]">
    ...
    <div id="sidebar" class="hidden md:block bg-red-50 border-red-700 border-r-2 fixed left-0 top-[72px] bottom-0 w-60 p-4 transition-all">
    ...
    <div id='navMobile' class='bg-white fixed bottom-0 right-0 left-0 border-t-2 border-t-cyan-700 -mb-56 md:hidden'>
        <button onclick="return setNavMobile()" class='absolute right-0 -top-[28px] bg-cyan-700 pt-1 px-3 rounded-tl-lg'>
